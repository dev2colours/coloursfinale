...
//   public showSequence: boolean = true;
//   public btnSequence: any = 'Show';
//   public showSeqChoice: boolean = false;
//   public btnSeqChoice: any = 'Show';
...
//   toggleSequence() {
//     this.showSeqChoice = !this.showSeqChoice;

//     if (this.showSeqChoice) {
//       this.btnSeqChoice = "Hide";
//     }
//     else { this.btnSeqChoice = "Show"; }
//   }
...
//       this.btnSequence = "Hide";
//     else
//       this.btnSequence = "Show";
//   }
...
//     // let userRef = this.afs.collection('Users').doc(this.myUser).collection('tasks');
