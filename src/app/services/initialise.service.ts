...
export class InitialiseService {
  ...
  constructor() {
    ...
    this.actionItem = { uid:"", id: "", name: "", unit: "", by: "", byId: "", type: "", quantity: 0, targetQty:0, rate: 0, amount: 0, champion: this.userChampion, classification: this.classification, participants: null, departmentName: "", departmentId: "", billID: "", billName: "", projectId: "", projectName: "", createdOn: "", UpdatedOn: "", actualData: null, workStatus: null, complete: false, start: null, end: null, startWeek: "", startDay: "", startDate: "", endDay: "", endDate: "", endWeek: "", taskName: "", taskId: "", companyId: "", companyName: "" };
    this.selectedAction = {uid: "", id: "", name: "", unit: "", by: "", byId: "", type: "", quantity: 0, targetQty: 0, rate: 0, amount: 0, champion: this.userChampion, classification: this.classification, participants: null, departmentName: "", departmentId: "", billID: "", billName: "", projectId: "", projectName: "", createdOn: "", UpdatedOn: "", actualData: null, workStatus: null, complete: false, start: null, end: null, startWeek: "", startDay: "", startDate: "", endDay: "", endDate: "", endWeek: "", taskName: "", taskId: "", companyId: "", companyName: "" };
    ...
    this.workItem = { uid:  "", id: "", name: "", unit: "", quantity: 0, targetQty:0, rate: 0, amount: 0, by: "", byId: "", type: "", champion: this.userChampion, classification: this.classification, participants: null, departmentName: "", departmentId: "", billID: "", billName: "", projectId: "", projectName: "", createdOn: "", UpdatedOn: "", actualData: null, workStatus: null, complete: false, start: null, end: null, startWeek: "", startDay: "", startDate: "", endDay: "", endDate: "", endWeek: "", taskName: "", taskId: "", companyId: "", companyName: "" };
